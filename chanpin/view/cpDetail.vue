<template>
	<view>
		...
		<view class="myCard">			
			<view class="cardTopName">产品编号：{{detail.F_ID}}</view>
			<view class="cardRow1" v-if="detail.spec">
										...
										<view class="cardRow1">
											<view>配件包：	</view>
											<u-checkbox :value="detail.pjb"/>
										</view>
										<view class="cardRow1">
											<view>说明书：</view>
											<u-checkbox :value="detail.sms"/>
										</view>
										<view class="cardRow1">
											<view>停用：</view>
											<u-checkbox :value="detail.F_Stop"/>
										</view>
		...
		<view class="spXQBox" v-if="detail_cs && detail_cs.length > 0">	</view>
