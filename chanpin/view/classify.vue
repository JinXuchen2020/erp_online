<template>
	<view>
		<dataNull v-if="list.length == 0" src="/static/img/chahua/dataNullXz.png" title="暂无相关分类" title1="点击添加按钮添加相关分类">
		</dataNull>
	...
	export default {
		...
		methods: {
			...
			addClassifyFun: function() {
				...
				obj.cjRenId = uni.$userInfo.id;
				obj.updateUid = uni.$userInfo.id;
				let reqData = {
					action: 'add',
