			...
			<view v-for="(item, index) in list" :key="index" @click="cardClick(item)">
				<view v-if="item.cpFmtList && item.cpFmtList.length > 0" class="myCard2">
					...
					<view class="rightView">
						...
						<view class="rowBtn">
							<u-button type="primary" :plain="true" class="cpBtn" size="mini" @click="setCpFun(item)">
								编辑产品
							</u-button>
				...
				<view v-else class="myCard">
					...
					<view class="rowBtn">
						<u-button type="primary" :plain="true" class="cpBtn" size="mini" @click="setCpFun(item)">编辑产品
						</u-button>
