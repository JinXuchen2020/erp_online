					...
					<view v-else class="myCard">
						...
						<view class="myCard3">
							...
							<view class="infoBox">
								...
								<view class="cardRow" v-if="item.F_Taxrate">
									<view>业务税率：</view>
									<view><text class="redColor">{{item.F_Taxrate}}</text></view>
								</view>
								<view class="cardRow" v-if="item.F_Tax">
									<view>业务税额：</view>
								...
								<view class="cardRow" v-if="item.F_FPTaxrate">
									<view>发票税率：</view>
									<view><text class="redColor">{{item.F_FPTaxrate}}</text></view>
								</view>
								<view class="cardRow" v-if="item.F_FPTotal">
									<view>税票成本：</view>
									<view><text class="redColor">{{item.F_FPTotal}}</text>元</view>
								</view>
							</view>
