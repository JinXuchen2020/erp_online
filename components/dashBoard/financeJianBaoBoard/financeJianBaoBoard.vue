		...
		methods: {
			...
			getSalesJianBaoFun: function() {
				...
				.then(res => {
					...
					list[0].value = res.data.skds;
					list[1].value = res.data.skje;
					list[2].value = res.data.fkds;
					list[3].value = res.data.fkje;
					list[4].value = res.data.yskh;
					list[5].value = res.data.ysje;
					list[6].value = res.data.yfkh;
					list[7].value = res.data.yfje;
