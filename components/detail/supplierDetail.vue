	...
	export default {
		...
		methods: {
			...
			gotoBaiDuFun: function(type) {
				uni.navigateTo({
					url: '/pages/webview/webview?name=' + that.khInfo.supplierName + '&type=' + type
				})
			},
			// 拨打电话
