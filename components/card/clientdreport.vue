	...
	<view>
		...
		<view class="card">
			<view class="topRow1" @click="gotoDetailFun">
				...
				<view >
					<text class="colorGray">发货人民币：</text>
					<text>¥：{{item.RMB}} 元</text>
				</view>
				<view >
					<text class="colorGray">退货人民币：</text>
					<text>¥：{{item.F_BackMoneyRMB}} 元</text>
				</view>
				<view >
					<text class="colorGray">合计人民币：</text>
					<text>¥：{{item.TotalRMB}} 元</text>
				</view>
				<view >
	...
	export default {
		...
		methods: {
			...
			gotoDetailFun: function() {
				...
				uni.navigateTo({
					url: './clientdreportdetail?index=' + this.index
				})
			},		
		}
	}
