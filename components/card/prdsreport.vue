	...
	<view>
		...
		<view class="card">
			<view class="topRow1" @click="gotoDetailFun">
				...
				<view >
					<text class="colorGray">工厂型号：</text>
					<text>{{item.spec}}</text>
				</view>
				<view >
				...
				<view >
					<text class="colorGray">数量：</text>
					<text>{{item.F_Qty}} PCS</text>
				</view>
				<view >
					<text class="colorGray">金额：</text>
					<text>{{item.F_Money}} 元</text>
				</view>	
				<view >
	...
	export default {
		...
		methods: {
			...
			gotoDetailFun: function() {
				...
				uni.navigateTo({
					url: './prdsreportdetail?index=' + this.index
				})
			},		
		}
	}
