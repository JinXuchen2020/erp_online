	...
	<view>
		...
		<view class="card">
			<view class="topRow1" @click="gotoDetailFun">
				...
				<view >
					<text class="colorGray">期初金额：</text>
					<text>{{item.f_qcmoney}}</text>
				</view>
				<view >
				...
				<view >
					...
					<text>{{item.f_back}}</text>
				</view>
				<view >
					<text class="colorGray">收款金额：</text>
					<text>{{item.f_accept}}</text>
				</view>
				<view >
					<text class="colorGray">折扣金额：</text>
					<text>{{item.f_dismoney}}</text>
				</view>
				<view >
					<text class="colorGray">应收金额：</text>
					<text>{{item.f_rest}}</text>
				</view>
				<view >
					<text class="colorGray">可冲预收：</text>
					<text>{{item.f_ysmoney}}</text>
				</view>				
			</view>		
	...
	export default {
		...
		methods: {
			...
			gotoDetailFun: function() {
				...
				uni.navigateTo({
					url: './receivablesdetail?index=' + this.index
				})
			},		
		}
	}
