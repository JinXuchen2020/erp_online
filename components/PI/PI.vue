	...
	export default {
		...
		methods: {
			...
			gotoDetailFun: function() {
				...
				uni.$PIInfo = this.item;
				uni.navigateTo({
					url: './PIDetail?index=' + this.index
				})
			},
			...
			// 删除订单
			deletePIFun: function(item, index) {
				var that = this;
				let delright = false;
				//确认权限
				let reqObjright = {
