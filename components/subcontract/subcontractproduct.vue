					...
					<view v-else class="myCard">
						...
						<view class="myCard3">
							...
							<view class="infoBox">
								...
								<view class="cardRow">
									<view>加工数量：</view>
									<view><text class="redColor">{{item.countt}}</text></view>
								</view>
								<view class="cardRow">
									<view>加工单价：</view>
								...
								<view class="cardRow">
									<view>加工金额：</view>
									<view><text class="redColor">{{item.account}}</text></view>
								</view>
								<view class="cardRow">
									<view>委外备注：</view>
									<view>{{item.bz}}</view>
				...
				uni.showModal({
					...
					success(rrr) {
						if (rrr.confirm) {
							...
							let reqData = {
								action: 'delsubcontractdetailById',
							...
							subcontractApi(reqData)
								.then(res => {
									...
									uni.$emit('delsubcontractdetailById', {
										index: that.index
									})
