		...
		<scroll-view scroll-y="true" :style="{height: scrollHeight}" @scrolltolower="selectclientFun"
			...
			<view v-if="list.length > 0">
				<view v-for="(item, index) in list" :key="index" >
					<selPrintfile :item="item" :isSelect="isSelect" :pageType="pageType" :index="index" @cxGetDataFun="cxGetDataFun"></selPrintfile>
				</view>
...
<script>
	...
	import selPrintfile from '@/components/cgzj/selPrintfile.vue'
	export default {
		components: {
			dataNull,
			addBtn,
