	...
	<view>
		...
		<uni-popup ref="popucountt" mode="center" width="666rpx" border-radius="14" :closeable="false">
			<view class="searchBox">
				...
				<u-field v-model="cgsl" :label="'检验数量'" :placeholder="'请输入检验数量'" clear-size="40"></u-field>
				<u-field v-model="kcsl" :label="'可出数量'" :placeholder="'请输入可出数量'" clear-size="40"></u-field>
	...
	export default {
		...
		methods: {
			...
			delcountt(index) {
				...
				this.list[index].kcsl = 0
				this.list[index].blsl = 0
			...
			inputcountFun: function() {
				...
				this.list[this.currency].kcsl = +this.kcsl
				this.list[this.currency].blsl = +this.blsl
				this.list[this.currency].Remark = this.Remark
				...
				if (num >= 0) {
					...
					this.itemList[num].kcsl = +this.kcsl
					this.itemList[num].blsl = +this.blsl
					this.itemList[num].Remark = this.Remark
					...
					item.count1 = this.list[this.currency].kcsl
					item.count2 = this.list[this.currency].blsl
					item.Remark = this.list[this.currency].Remark
					...
					item.wjsl=this.list[this.currency].count2
						...
						for (var i = 0; i < data.length; i++) {
							for (var j = 0; j < itemList.length; j++) {
								if ((itemList[j].itemcode == data[i].itemcode) && (itemList[j].dyxs == data[i]
									...
									data[i].kcsl = itemList[j].count1
									data[i].blsl = itemList[j].count2
									data[i].Remark = itemList[j].Remark
