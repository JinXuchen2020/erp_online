		...
		<scroll-view scroll-y="true" :style="{height: scrollHeight}" @scrolltolower="selectclientsreportFun"
			...
			<view v-if="list.length > 0">
				<view v-for="(item, index) in list" :key="index" @click="khCardClickFun(item)">
					<prdrreportCard :item="item" :isSelect="isSelect" :index="index" @cxGetDataFun="cxGetDataFun"></prdrreportCard>
				</view>
...
<script>
	...
	import prdrreportCard from '@/components/card/prdrreport.vue'
	export default {
		components: {
			dataNull,
			getMore,			
