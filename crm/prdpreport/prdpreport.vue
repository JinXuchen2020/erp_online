		...
		<scroll-view scroll-y="true" :style="{height: scrollHeight}" @scrolltolower="selectclientsreportFun"
			...
			<view v-if="list.length > 0">
				<view v-for="(item, index) in list" :key="index" @click="khCardClickFun(item)">
					<prdpreportCard :item="item" :isSelect="isSelect" :index="index" @cxGetDataFun="cxGetDataFun"></prdpreportCard>
				</view>
...
<script>
	...
	import prdpreportCard from '@/components/card/prdpreport.vue'
	export default {
		components: {
			dataNull,
			getMore,			
