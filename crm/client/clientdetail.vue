<template>
	<view class="content">
		...
		<z-paging ref="paging" :auto-clean-list-when-reload="false" :auto-scroll-to-top-when-reload="false"
			...
			<!--客户基本信息-->
			<clientCard :item="khInfo" :index="cardIndex" :isSelect="true"></clientCard>
			...
			<view class="contentView">
				...
				<view v-if="tabIndex == 0">
					<clientDetail :khInfo="khInfo"></clientDetail>
				</view>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			...
			uni.$on('refreshClientFun', that.refreshClientFun)
		},
		onBackPress(e) {
			...
			uni.$off('refreshClientFun', that.refreshClientFun)
		},
		onShow() {
