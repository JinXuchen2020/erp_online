		...
		<scroll-view scroll-y="true" :style="{height: scrollHeight}" @scrolltolower="selectclientsreportFun"
			...
			<view v-if="list.length > 0">
				<view v-for="(item, index) in list" :key="index" @click="khCardClickFun(item)">
					<prddreportCard :item="item" :isSelect="isSelect" :index="index" @cxGetDataFun="cxGetDataFun"></prddreportCard>
				</view>
...
<script>
	...
	import prddreportCard from '@/components/card/prddreport.vue'
	export default {
		components: {
			dataNull,
			getMore,			
